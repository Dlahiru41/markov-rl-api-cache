...
def test_basic_operations():
    ...
    print("[OK] Basic probability calculations correct\n")
...
def test_top_k():
    ...
    print("[OK] Top-k functionality working correctly\n")
...
def test_serialization():
    ...
    tm.save(test_file)
    print(f"[OK] Saved matrix to {test_file}")

    # Load from file
    tm2 = TransitionMatrix.load(test_file)
    print(f"[OK] Loaded matrix from {test_file}")
    ...
    print(f"[OK] Probabilities match: {prob1:.3f} == {prob2:.3f}")
    ...
    print(f"[OK] Counts match: {count1} == {count2}")

    # Clean up
    if os.path.exists(test_file):
        os.remove(test_file)
        print(f"[OK] Cleaned up {test_file}\n")
...
def test_statistics():
    ...
    print("\n[OK] Statistics generation working correctly\n")
...
def test_merge():
    ...
    print("[OK] Matrix merge working correctly\n")
...
def test_smoothing():
    ...
    print("[OK] Smoothing working correctly\n")
...
def test_dataframe_conversion():
    ...
    try:
        ...
        print("\n[OK] DataFrame conversion working correctly\n")
